...
(deftest HaploidKaryotype
  (is (r/isuperclass? i/k26_X_+4_+6_+21 n/HaploidKaryotype))
  )
...
(deftest StructuralAbnormalKaryotypeAddition
  (is (r/isuperclass? i/k46_XX_add!19!!p13.3! n/StructuralAbnormalKaryotypeAddition))
  (is (r/isuperclass? i/k46_XY_add!12!!q13! n/StructuralAbnormalKaryotypeAddition))
  )

(deftest StructuralAbnormalKaryotypeDeletion
  (is (r/isuperclass? i/k46_XX_del!5!!q13! n/StructuralAbnormalKaryotypeDeletion))
...
(deftest StructuralAbnormalKaryotypeDuplication
  (is (r/isuperclass? i/k46_XX_dup!1!!q22q25! n/StructuralAbnormalKaryotypeDuplication))
  (is (r/isuperclass? i/k46_XY_dup!1!!q25q22! n/StructuralAbnormalKaryotypeDuplication))
  )

(deftest StructuralAbnormalKaryotypeFission
  (is (r/isuperclass? i/k47_XY_-10_+fis!10!!p10!_+fis!10!!q10! n/StructuralAbnormalKaryotypeFission))
  )

(deftest StructuralAbnormalKaryotypeInsertion
  (is (r/isuperclass? i/k46_X_ins!5_X!!p14_q21q25! n/StructuralAbnormalKaryotypeInsertion))
  (is (r/isuperclass? i/k46_XX_ins!2!!p13q21q31! n/StructuralAbnormalKaryotypeInsertion))
  (is (r/isuperclass? i/k46_XX_ins!2!!q13p13p23! n/StructuralAbnormalKaryotypeInsertion))
  (is (r/isuperclass? i/k46_XX_ins!2!!q13p23p13! n/StructuralAbnormalKaryotypeInsertion))
  (is (r/isuperclass? i/k46_XX_ins!5_2!!q31_p13p23! n/StructuralAbnormalKaryotypeInsertion))
  (is (r/isuperclass? i/k46_XX_ins!5_2!!q31_p23p13! n/StructuralAbnormalKaryotypeInsertion))
  (is (r/isuperclass? i/k46_XY_ins!2!!p13q31q21! n/StructuralAbnormalKaryotypeInsertion))
  (is (r/isuperclass? i/k46_XY_ins!5_2!!p14_q22q32! n/StructuralAbnormalKaryotypeInsertion))
  (is (r/isuperclass? i/k46_XY_ins!5_2!!p14_q32q22! n/StructuralAbnormalKaryotypeInsertion))
  )
...
(deftest StructuralAbnormalKaryotypeTriplication
  ...
  (is (r/isuperclass? i/k46_XX_trp!1!!q21q32! n/StructuralAbnormalKaryotypeTriplication))
  )
...
(deftest KlinefelterSyndromeMostCommonVariation
  ...
  (is (not (r/isuperclass? i/k48_XXYY n/KlinefelterSyndromeMostCommonVariation)))
  (is (not (r/isuperclass? i/k48_XXYc_+X n/KlinefelterSyndromeMostCommonVariation)))
  (is (not (r/isuperclass? i/k48_XY_+X_+Y n/KlinefelterSyndromeMostCommonVariation)))
  (is (not (r/isuperclass? i/k49_XXYYY n/KlinefelterSyndromeMostCommonVariation)))
  )
...
(deftest DownSyndrome
  ...
  (is (r/isuperclass? i/k47_X_t!X_13!!q27_q12!_inv!10!!p13q22!_+21 n/DownSyndrome))
