...
(deftest NumericalAbnormalKaryotypeAutosomalGain
  (is (r/isuperclass? i/k26_X_+4_+6_+21
  ...
  (is (r/isuperclass? i/k70_XXX_+del!7!!p11.2!
                      n/NumericalAbnormalKaryotypeAutosomalGain))
  (is (r/isuperclass? i/k71_XXX_+8_+10
                      n/NumericalAbnormalKaryotypeAutosomalGain))
...
(deftest NumericalAbnormalKaryotypeAutosomalLoss
  ...
  (is (r/isuperclass? i/k46_XX_+8_-21
                      n/NumericalAbnormalKaryotypeAutosomalLoss))
  (is (r/isuperclass? i/k46_XY_+21c_-21
                      n/NumericalAbnormalKaryotypeAutosomalLoss))
...
(deftest StructuralAbnormalKaryotypeAddition
  ...
  (is (r/isuperclass? i/k46_XY_add!12!!q13!
                      n/StructuralAbnormalKaryotypeAddition)))
...
(deftest KlinefelterSyndrome
  ;; TOFIX
  ;; (is (r/isuperclass? i/k47_XXY n/KlinefelterSyndrome))

  (is (not (r/isuperclass? i/k48_XXYY n/KlinefelterSyndrome)))
  (is (not (r/isuperclass? i/k48_XXYc_+X n/KlinefelterSyndrome)))
  (is (not (r/isuperclass? i/k48_XY_+X_+Y n/KlinefelterSyndrome)))
  (is (not (r/isuperclass? i/k49_XXYYY n/KlinefelterSyndrome))))

(deftest MaleWithExtraX
  ;; TOFIX
  ;; (is (r/isuperclass? i/k48_XXXY n/MaleWithExtraX))
  ;; (is (r/isuperclass? i/k49_XXXXY n/MaleWithExtraX))
  ;; (is (r/isuperclass? i/k49_XXXYY n/MaleWithExtraX))
  ;; (is (r/isuperclass? i/k48_XXYY n/MaleWithExtraX))
  ;; (is (r/isuperclass? i/k48_XXYc_+X n/MaleWithExtraX))
  ;; (is (r/isuperclass? i/k48_XY_+X_+Y n/MaleWithExtraX))
  ;; (is (r/isuperclass? i/k49_XXYYY n/MaleWithExtraX))
)

;; (deftest MaleWithExtraY)
;; (TripleXSyndrome)
;; (deftest FemaleWithExtraX)
;; (deftest Lethal)

;; TOFIX
;; Named Karyotypes - Autsomal Abnormalities
(deftest WarkanySyndrome2
  ;; TOFIX
  ;; (is (r/isuperclass? i/k46_XX_+8_-21 n/WarkanySyndrome2))
...
;; (deftest CriDuChat)
;; (deftest Chromosome51DeletionSyndrome)
...
;; (deftest Chromosome18qDeletionSyndrome)
