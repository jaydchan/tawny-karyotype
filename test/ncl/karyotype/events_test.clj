...
(deftest addition
  (is (= (o/exactly 1 e/hasEvent
                    (o/owland e/Addition h/HumanChromosome1))
         (e/addition 1 h/HumanChromosome1)))

  (is (= (o/exactly 1 e/hasEvent
                    (o/owland e/Addition h/HumanChromosome))
         (e/addition 1 h/HumanChromosome)))

  (is (= (o/exactly 1 e/hasEvent
                    (o/owland e/Addition
                              (o/owlsome e/hasBreakPoint
...
;; (deftest deletion
;;   (is (= (o/exactly 1 e/hasEvent
;;                     (o/owland e/Deletion h/HumanChromosome1))
;;          (e/addition 1 h/HumanChromosome1)))

;;   (is (= (o/exactly 1 e/hasEvent
;;                     (o/owland e/Deletion h/HumanChromosome))
;;          (e/addition 1 h/HumanChromosome)))
